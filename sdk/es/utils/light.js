...
export function wrapperLightAttr(lightElement, _a, appendEl, runtime) {
    ...
    var variable = "--bgcolor:".concat(bgColor, ";--color:").concat(textColor, ";--bgbottomcolor:").concat(bottomColor, ";");
    if (lightElement.tagName.toUpperCase() === 'LIGHT') {
        variable += "background-image: linear-gradient(0deg,".concat(bgColor, " 2em,").concat(bgColor, " 0);");
    }
