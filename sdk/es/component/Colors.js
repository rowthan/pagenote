...
export default function Colors(_a) {
    ...
    return (React.createElement("pagenote-colors", null,
        React.createElement("pagenote-color-items", null, colors.map(function (color) {
            return React.createElement("pagenote-icon", { "aria-controls": 'color-item', onClick: function () { setColor(color); }, "data-active": "" + (color === current ? '1' : ''), style: { backgroundColor: color } });
        })),
