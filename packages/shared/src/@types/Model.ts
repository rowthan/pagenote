...
export type LinkPageInfo = {
    webpageKey?: string;
    source?: string
    canonical?: string | null // 如果有则说明当前网址和归一化指向的网址不同，用于多个URL映射到同一个网页的指向标准。
    // sessionId?: string; // 关联性访问，例如 pageA - > YouTube 能够将其关联性记录下来。
    domain?: string;
}
...
export type Note = CommonModelInfo & {
    ...
    tags?: string[]
    relatedType?: "domain"|"url"|"custom"|"urlPath"|"tag"|"light"
    /**@deprecated*/
    url?: string
    /**@deprecated*/
    path?: string
